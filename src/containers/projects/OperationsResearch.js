...
const BulletTypography = styled(Typography)({
  '&::before': {
    ...
    width: '1em',    // Ensures a fixed width for alignment
  ...
  return (
    <Container maxWidth="lg">
      <ThemeProvider theme={theme}>
        ...
        {/* Title */}
        <Typography variant="h3" component="h1" gutterBottom style={{ marginTop: '4rem', fontWeight: 800, fontFamily: 'Montserrat, sans-serif' }}>
        ...
        <ContributionContainer>
          <TextSection>
            ...
            <BulletTypography style={{ paddingTop: '20px', paddingLeft: '15px' }}>
              The objective of this project was to enhance the self-scheduling system for ED nurses.
            </BulletTypography>
            <BulletTypography style={{ paddingLeft: '15px' }}>
            ...
            <BulletTypography style={{ paddingBottom: '20px', paddingLeft: '15px' }}>
          ...
          <ImageSection>
            <Image src={process.env.PUBLIC_URL + '/assets/images/operations-research.png'} alt="nursing schedule" />
          </ImageSection>
        </ContributionContainer>
        ...
        {/* Image */}
        <img 
          src={process.env.PUBLIC_URL + "/assets/images/nursing-scheduling-table-1.png"} 
          alt="CPPLibrary" 
        ...
        {/* Image */}
        <img 
          src={process.env.PUBLIC_URL + "/assets/images/nursing-scheduling-figure-1.png"} 
          alt="CPPLibrary" 
        ...
        <VariableDescription />
        <Typography variant="body1" gutterBottom component="div" style={{ paddingTop: '20px', fontSize: '1.25rem', lineHeight: '1.6', fontWeight: 'bold' }}>
          Parameters 
        </Typography>
        <BulletTypography style={{fontSize: '1.2rem', paddingLeft: '15px' }}>
        ...
        <BulletTypography style={{ fontSize: '1.2rem', paddingBottom: '20px', paddingLeft: '15px' }}>
        ...
        {/* Image */}
        <img 
          src={process.env.PUBLIC_URL + "/assets/images/nursing-scheduling-table-2.png"} 
          alt="CPPLibrary" 
          style={{ display: 'block', width: '50%', height: 'auto', marginLeft: 'auto', marginRight: 'auto', marginBottom: '20px', boxShadow: '0px 0px 6px 0px #66bb6a'}}
        />

        <Typography variant="body1" gutterBottom component="div" style={{ fontSize: '1.20rem', lineHeight: '1.6' }}>
        ...
        {/* Image */}
        <img 
          src={process.env.PUBLIC_URL + "/assets/images/nursing-scheduling-table-3.png"} 
          alt="CPPLibrary" 
          style={{ display: 'block', width: '50%', height: 'auto', marginLeft: 'auto', marginRight: 'auto', marginBottom: '20px', boxShadow: '0px 0px 6px 0px #66bb6a'}}
        />
        <Typography variant="body1" gutterBottom component="div" style={{ fontSize: '1.25rem', lineHeight: '1.6', fontWeight: 'bold' }}>
        ...
        {/* Image */}
        <img 
          src={process.env.PUBLIC_URL + "/assets/images/nursing-scheduling-table-4.png"} 
          alt="CPPLibrary" 
          style={{ display: 'block', width: '50%', height: 'auto', marginLeft: 'auto', marginRight: 'auto', marginBottom: '20px', boxShadow: '0px 0px 6px 0px #66bb6a'}}
        />
        <Typography variant="body1" gutterBottom component="div" style={{ fontSize: '1.25rem', lineHeight: '1.6', fontWeight: 'bold' }}>
        ...
        {/* Image */}
        <img 
          src={process.env.PUBLIC_URL + "/assets/images/nursing-scheduling-table-5.png"} 
          alt="CPPLibrary" 
        ...
        <Typography variant="body2" style={{ fontStyle: 'italic', fontSize: '1rem', marginBottom: '50px' }}>
