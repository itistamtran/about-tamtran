...
export default function ContactPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full min-h-screen p-6 " style={{ backgroundColor: '#1a1a1a', color: 'white' }}>
            <h1 className="mb-6 text-3xl font-bold text-center" style={{ marginTop: '-50px' }}>Get In Touch With Me</h1>
            ...
            <div className="flex flex-col w-full max-w-5xl gap-8 md:flex-row" style={{ marginLeft: '80', marginTop: '50px' }}>
                ...
                <div className="flex-1 text-left">
                    ...
                    <p style={{ fontSize: '1.2rem', color: '#cccccc', marginTop: '10px', display: 'flex', alignItems: 'center' }}>
                        ...
                        <a href="mailto:itistamtran@gmail.com" style={{ fontSize: '1.2rem', fontWeight: 600, color: '#4ADE80', marginLeft: '8px' }}>
                ...
                <div className="flex-1 w-full max-w-2xl p-6 bg-gray-800 rounded-lg shadow-md md:max-w-4xl lg:max-w-5xl">
                    {submitted ? (
                        <p className="text-center text-[#38a169]">Thank you! Your message has been sent.</p>
                    ) : (
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            <button type="submit" className="bg-white hover:bg-[#4ADE80] text-black hover:text-black p-3 rounded-lg font-bold">Submit</button>
                        </form>
                    )}
                </div>
            </div>
