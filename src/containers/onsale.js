...
export default function OnSalePage() {
    return (
        <div className="flex flex-col items-center w-full min-h-screen p-6 text-white bg-gray-900">
            <h1 className="mb-6 text-3xl font-bold">For Sale</h1>
            <p className="mb-6 text-gray-400">Explore my collection of images available for sale on Shutterstock.</p>
                ...
                {products.map((product) => (
                    <div key={product.id} className="overflow-hidden bg-gray-800 rounded-lg shadow-md">
                        ...
                        <div className="p-4">
                            ...
                            <a href={product.link} target="_blank" rel="noopener noreferrer" className="text-[#4ADE80] hover:underline">Buy on Shutterstock</a>
                        </div>
                    </div>
                ))}
            </div>
            ...
            {/* See More Button */}
            <div className="mt-8">
                <a href="https://www.shutterstock.com/g/H2Peace" target="_blank" rel="noopener noreferrer" className="px-6 py-2 text-lg font-bold text-[#4ADE80] transition duration-300 border-2 border-[#4ADE80] rounded-lg hover:bg-[#4ADE80] hover:text-black">
                    See More
                </a>
            </div>
        </div>
