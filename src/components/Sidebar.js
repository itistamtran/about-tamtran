...
const Sidebar = () => {
  console.log(
    new URL("about-tamtran/assets/images/avatar.png", document.baseURI).href,
  ); // This will log the absolute URL to the console
  ...
  return React.createElement(
    "div",
    {
      className: "w-64 bg-black text-white flex flex-col justify-between p-5",
    },
    React.createElement(
      "div",
      {
    ...
    React.createElement(
      "div",
      { className: "flex justify-center items-center space-x-6 mt-4 p-5" },
      React.createElement(
        "a",
        {
        ...
        React.createElement(FaLinkedin, { className: "h-6 w-6" }),
      ),
      React.createElement(
        "a",
        {
        ...
        React.createElement(FaGithub, { className: "h-6 w-6" }),
      ),
    ),
    React.createElement(
      "div",
